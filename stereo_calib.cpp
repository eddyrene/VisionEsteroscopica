...
static int print_help()
{
    ...
    cout << "Usage:\n ./stereo_calib -w=<board_width default=7> -h=<board_height default=5> <image list XML/YML file default=capturas.xml>\n" << endl;
    return 0;
}
...
int main(int argc, char** argv)
{
    ...
    string imagelistfn;
    bool showRectified;
    cv::CommandLineParser parser(argc, argv, "{w|7|}{h|5|}{nr||}{help||}{@input|capturas.xml|}");
    if (parser.has("help"))
        return print_help();
